...
class PT_Block_Image2 extends PT_Shortcode {
	...
	function __construct(){
		...
		$this->image  = PT_URL."/assets/images/admin/icon/image-block2.jpg";
		parent::__construct();
	}
	...
	ob_start();
	?>
	<div class="<?php echo esc_attr($extra_class); ?> image-block2 clearfix" style="background-color:<?php echo $bgcolor; ?>;color:<?php echo $txtcolor; ?>;border-color:<?php echo $bdcolor; ?>">
	 
        	<?php if(isset($imagesrc)){ ?> 
			  <div class="image <?php if($imgalign == "right"){ echo 'pull-right'; } ?>">				    
	...
	public function shortcode_options( $atts ){
		...
		$options = array(
			...
			array(
				'id' => 'imgalign',
				'title' => __( 'Image Alignment', 'pt-builder' ),
				'desc' => __( 'Choose which side the image is displayed on.', 'pt-builder' ),
				'type' => 'select',
				'options' => array(
					'left' => "Left",
					'right' => "Right",
