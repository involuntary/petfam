...
class PT_Core_Carousel_Blog extends PT_Shortcode{
	
	public $icon = '<span class="fa fa-rotate-right"></span>';
	public $name = 'Blog Carousel';
	public $description = 'Add a blog carousel block to the page';
	public $category = '8. Dynamic Content';
	public $image;
	public $default_options = array(
		'element_name' => 'Blog Carousel',
		'arrows' => 'no',
		'perrow' => '4',
	...
	public function shortcode_frontend( $atts, $content ){
		...
		<?php echo do_shortcode('[LISTINGS dataonly=1 show=12 query="'.$query.'" type="post"]'); ?> 
		</div>
