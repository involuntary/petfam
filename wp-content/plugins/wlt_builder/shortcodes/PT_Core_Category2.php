...
class PT_Core_Category2 extends PT_Shortcode{
	...
	function __construct(){
		...
		$this->image  = PT_URL."/assets/images/admin/icon/category2.jpg";
		parent::__construct();
	}
...
<div class="wlt_builder_category style2 cols3">
