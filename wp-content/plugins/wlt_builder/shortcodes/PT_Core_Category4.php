...
class PT_Core_Category4 extends PT_Shortcode{
	...
	function __construct(){
		...
		$this->image  = PT_URL."/assets/images/admin/icon/category4.jpg";
		parent::__construct();
	}
...
<div class="wlt_builder_category style4 ex2 cols3">
