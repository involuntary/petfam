...
<div class="row">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12 pull-left adminedit1">

        <?php //get_template_part('add', 'packages' ); ?>
        <?php get_template_part('add', 'myaccount-sidebar' ); ?>

    </div>

    <div class="col-md-9 col-sm-9 col-xs-12 pull-right adminedit2">

        <?php get_template_part('add', 'form' ); ?>
        <?php get_template_part('middle', 'account-add-packages' ); ?>
