            ...
            <div class="row white">
                <div class="col-md-6 no-pad">
                    <div class="coralbg user-pad toppad">
                        ...
                        <h4 class="white">[CATEGORY] / [neighbourhood] </h4>

												<?php  ?>
                        <?php if($d != ""){ ?>
                        <h4 class="white"> [CITY] / [LOCATION-FLAG] </h4>
                        <?php } ?>
...
<div class="tab-content">
        ...
        <div class="tab-pane active" id="t1">
            ...
            <?php if($a != ""){ ?>
            <h3><?php echo $CORE->_e(array('dating','31')); ?></h3>
            <?php echo wpautop($a); ?>
            <?php } ?>
        ...
        <div class="tab-pane" id="t2">
            ...
            <?php if($a != ""){ ?>
            <h3><?php echo $CORE->_e(array('dating','33')); ?></h3>
            [LISTINGDATA type=1]
            <?php } ?>
