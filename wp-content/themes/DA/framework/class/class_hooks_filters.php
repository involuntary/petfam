...
function hook_content_templatename($c){ return  apply_filters('hook_content_templatename', $c);  }
	...
	function hook_account_dashboard_before(){  do_action('hook_account_dashboard_before');  }
	function hook_account_dashboard_after(){  do_action('hook_account_dashboard_after');  }
	function hook_account_dashboard_items($c){   return  apply_filters('hook_account_dashboard_items', $c);   }	
	...
	function hook_items_after(){  do_action('hook_items_after');  }
		function hook_items_after_filter($c){ return  apply_filters('hook_items_after_filter', $c);  }
	 
	function hook_item_class(){   do_action('hook_item_class');   }	
	
	function hook_sidebarcontent_filter($c){ return  apply_filters('hook_sidebarcontent_filter', $c);  }
	
 
	function hook_after_searchbox(){  do_action('hook_after_searchbox');  }
