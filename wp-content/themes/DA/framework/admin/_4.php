...
// [MYSQL] INSTALL SESSION TABLE FOR CART
 $wpdb->query("CREATE TABLE IF NOT EXISTS `".$wpdb->prefix."core_sessions` (
  ...
  PRIMARY KEY (`session_key`));");
		...
		echo "<h1>Tabled Reinstalled Successfull</h1>";
		die();
...
<div class="clearfix"></div>
           ...
           <div class="box gradient">
        <div class="title">
          <h4><i class="gicon-refresh"></i><span>Database Tables</span></h4>
        </div>
            <div class="content top">
            
            <div class="well">	
<b>Missing Tables</b>	 
 <a href="admin.php?page=4&amp;task=retables&amp;TB_iframe=true&amp;width=640&amp;height=100" class="alertme button right" >Reinstall </a> 
<div class="clearfix"></div>
</div> 
