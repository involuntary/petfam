...
?>
    ...
    <div class="box gradient span8">
      ...
      <div class="title">
            <div class="row-fluid"><h3><i class="gicon-folder-open"></i>Installed Payment Gateways</h3></div>
        </div><!-- End .title -->
...
<?php } ?>
 ...
 <?php $i++; } }  ?>       
        ...
        <div class="alert alert-info"><b>Note:</b> More payment gateways can be found on the <a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=10" style="text-decoration:underline;"> theme plugins page here</a></div>
...
<div class="span4"> 
        ...
        <div class="box gradient">
          <div class="title"><h3><i class="gicon-wrench"></i><span>Currency Settings</span> </h3></div>
          <div class="content">
...
<!----------------- FIELD -------->
 <div class="form-row control-group row-fluid">
    ...
    <div class="controls">
    	...
    	<select class="row-fluid" name="admin_values[currency][dec]">
        <option value="" <?php selected( $core_admin_values['currency']['dec'], "" ); ?>>2 (default) </option>
         <option value="3" <?php selected( $core_admin_values['currency']['dec'], 3 ); ?>>3 </option>
         <option value="4" <?php selected( $core_admin_values['currency']['dec'], 4 ); ?>>4 </option>
         <option value="5" <?php selected( $core_admin_values['currency']['dec'], 5 ); ?>>5 </option>
        </select>
    </div>
</div>   
<!-----------------END  FIELD -------->
...
<div class="box gradient">
          <div class="title"><h3><i class="gicon-tasks"></i><span>Invoice Settings</span> </h3></div>
          <div class="content">
