...
<div class="tab-content" style="background:#fff; min-height:500px;">
  <div class="tab-pane active" id="od1">
        ...
        <?php 
		 ...
		 if(isset($GLOBALS['global_cart_data'])){ global $CORE_CART; $CORE->Language(); 
		 
$GLOBALS['global_cart_data']['shipping'] 	= $order->order_shipping;
$GLOBALS['global_cart_data']['tax'] 		= $order->order_tax;
$GLOBALS['global_cart_data']['total'] 		= $order->order_total;
		...
		if(strlen($GLOBALS['global_cart_data']['comments']) > 0 ){ echo  "<hr> <p> User Comments</p> <div class='well'>".$GLOBALS['global_cart_data']['comments']."</div>"; } ?>
