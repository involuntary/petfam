...
$returnlink = get_permalink($_POST['paid_item_id']);

if($returnlink == ""){  $returnlink = $GLOBALS['CORE_THEME']['links']['myaccount']; }
...
<div class="panel-heading"><?php echo $CORE->_e(array('callback','1')); ?></div>
    ...
    <a href="<?php echo $returnlink; ?>" style="text-decoration:underline"><?php echo $CORE->_e(array('callback','10')); ?></a>
